...
using Bbin.Sniffer;
using Bbin.SnifferWebApp.Models;
...
namespace Bbin.SnifferWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(Configuration.GetSection("BaiduConfig").Get<BaiduConfig>());
            services.AddSingleton(Configuration.GetSection("BbinConfig").Get<BbinConfig>());
            services.AddSingleton(Configuration.GetSection("SiteConfig").Get<SiteConfig>());
